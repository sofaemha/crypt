...
const Editor = dynamic(() => import("@/components/container/editor"), { ssr: false });
...
export default function Create() {
  ...
  return (
    <>
      ...
      <Button variant="outline" disabled={disabled} className="rounded-xl sm:rounded-md h-auto px-5 py-3 mb-2 mt-4 ml-auto mr-4 sm:mx-0 sm:w-full flex items-center justify-center font-medium bg-white dark:bg-slate-900 dark:text-white">
        Encrypt
