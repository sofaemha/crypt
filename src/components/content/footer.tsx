      ...
      <footer className="sm:rounded-lg rounded-t-3xl shadow border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div className="w-full max-w-screen-xl mx-auto p-8 sm:p-4 text-start flex items-center justify-between">
          ...
          <ul className="flex flex-wrap items-center justify-center sm:justify-normal mt-1 sm:mt-0">
            <li>
              <Button variant="link" onClick={toggleIsOpen} className="list-item md:hidden mr-4 p-0 h-auto hover:underline hover:decoration-dotted sm:mr-6 text-gray-500 dark:text-gray-400">
                Command
              </Button>
            </li>
            <li>
              <Button variant="link" className="list-item md:hidden mr-4 p-0 h-auto hover:underline hover:decoration-dotted sm:mr-6 text-gray-500 dark:text-gray-400">
                FAQ
              </Button>
              <Button variant="link" className="hidden md:list-item mr-4 p-0 h-auto hover:underline hover:decoration-dotted sm:mr-6 text-gray-500 dark:text-gray-400">
